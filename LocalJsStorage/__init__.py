...
class LocalJsStorage:
    ...
    def __getDicc(self,path,listPath): 
        ...
        #-----------------------------
        keys=list(Dicc.keys())
        if "__time__" in keys and "__timeVars__"  in keys and "__tags__" in keys:
    ...
    def __addTimeJSON(self,path):  # OK
        ...
        pathTime=join(path,"__data__.json")
        ...
        dicTime=dumps({"__time__":nownum,"__timeVars__":nowint,"__tags__":[]})
