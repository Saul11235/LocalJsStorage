...
function LJS_eval(key,args) {
  var funcs=LJS_getMainFuncs();
  var fun=funcs[key];
  if (fun !== undefined ) {
    LocalJsStorage_key=key;
    LocalJsStorage_args=args;
    fun(args);
    return true;
  } else {
    return false;
...
console.log(LJS_eval("key","myvarss"));
console.log(LJS_eval("key","myothersvarss"));
console.log(LJS_eval("nokey","myothersvarss"));
