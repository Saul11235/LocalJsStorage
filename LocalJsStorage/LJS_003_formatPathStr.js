...
function LJS_formatPathStr(path){
...
console.log("test LJS_formatPathStr");
//console.log(LJS_formatPathStr("child1/child2"));
console.log(LJS_formatPathStr(["child1","child2"]));
console.log(LJS_formatPathStr([1,2,3]));
console.log(LJS_formatPathStr([]));
console.log(LJS_formatPathStr(["lolo","lala"]));
