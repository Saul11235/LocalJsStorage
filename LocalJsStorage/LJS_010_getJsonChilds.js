...
function LJS_makeUrl(key="",value=""){let skey=key;let svalue=value;if(Array.isArray(key)){skey=key[0];svalue=key[1];};let add="?"+skey+"="+svalue;if(value===""){add="?"+skey};if(add==="?"){add=""};return window.location.href.split("?")[0]+add;};
